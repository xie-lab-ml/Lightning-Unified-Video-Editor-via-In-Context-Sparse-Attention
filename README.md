...
**LIVE-EDITOR** addresses this with **In-Context Sparse Attention**: a lightweight, training-free block-retrieval mechanism that efficiently selects the most relevant source-video tokens for each query block, avoiding the need for dense attention over the full sequence.
...
| **LIVE-EDITOR** | **0.289** | **0.215** | **0.911** | **0.981** |
