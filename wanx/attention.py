...
def flash_attention(
    ...
    Prefers FA3 (flash_attn_interface), falls back to FA2.
    """
    ...
    if (version is None or version == 3) and FLASH_ATTN_3_AVAILABLE:
        ...
        if int(str(torch.__version__).split(".")[1]) >= 4:
        ...
        x = flash_attn.flash_attn_varlen_func(
            ...
            window_size=window_size, deterministic=deterministic)[0].unflatten(0, (b, lq))
